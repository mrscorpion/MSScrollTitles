...
@interface MSCursorView ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
-(UICollectionView*)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[MSSelectorCell class] forCellWithReuseIdentifier:cellIdentifier];
...
{
    MSSelectorCell *cell = (MSSelectorCell*)[self.collectionView cellForItemAtIndexPath:indexPath];
    cell.selected = YES;
...
{
    MSSelectorCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
{
    MSSelectorCell *cell = (MSSelectorCell*)[collectionView cellForItemAtIndexPath:indexPath];
    cell.selected = NO;
}
